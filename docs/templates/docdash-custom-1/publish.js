...
function addMethodAliases(f){
    if( f.alias ){
        var aliases = []

        f.alias.split(',').forEach(function( alias ) {
        ...
        if (symbols[module.longname]) {
            module.modules = symbols[module.longname]
                ...
                .map(function(symbol) {
                    ...
                    //console.log('symbol: %s; droop symbol: %s', symbol, doop(symbol))
                    ...
                    //console.log('NAME: %s:%s%s', symbol.kind, symbol.name,symbol)
