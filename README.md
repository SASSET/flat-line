...
* **[_.passwordVerify](https://github.com/jhyland87/lodash-mixins#_isuniq-array-collection--string-element--)** - Validate the uniqueness of an array, of objects in an array, or of a specific element in the objects in an array
