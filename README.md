...
* **[_.randStr](https://github.com/jhyland87/lodash-mixins#_randStr)** - Generate a random alpha-numeric string
* **[_.hash](https://github.com/jhyland87/lodash-mixins#_hash)** - Generate a salted hash
* **[_.passwordHash](https://github.com/jhyland87/lodash-mixins#_passwordHash)** - Generate a randomly generated salted password hash, (which can only be verified via [_.passwordVerify](https://github.com/jhyland87/lodash-mixins#_passwordVerify))
* **[_.passwordVerify](https://github.com/jhyland87/lodash-mixins#_passwordVerify)** - Verify the hash generated by [_.passwordHash](https://github.com/jhyland87/lodash-mixins#_passwordHash)
